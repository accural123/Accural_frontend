// ===== src/components/common/SearchableRecords.jsx =====
/**
 * SearchableRecords component - wrapper for records list with search
 * Features: gradient header, search input, loading states
 */
