              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white">
                    Prior Year Income (1088)
                  </h1>
                  <p className="text-green-100 mt-1">
                    For The Year Ended 31/03/2025 • GJV • {journalNo} • {journalDate}
                  </p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="bg-white px-6 py-4 border-t flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={handleSave}
                className="px-6 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 transition-colors flex items-center space-x-2"
              >
...
export default PriorYearIncomeForm;